...
1. **Clone the Starter Repository**  
   - Clone the [starter code](https://github.com/tx00-resources-en/exam-starter) repository and name it `exam-web-dev` as follows: 
     ```bash
     git clone https://github.com/tx00-resources-en/exam-starter exam-web-dev
     ```
